...
# vasprun.py v1.0 3-22-2014 Jeff Doak jeff.w.doak@gmail.com
...
class VaspRun(object):
    ...
    def __init__(self,input_=None):
        ...
        self.atom_names = [ i[0].text for i in self.root.find('atominfo').findall('array')[0].find('set') ]
        self.atom_indices = [ int(i[1].text)-1 for i in self.root.find('atominfo').findall('array')[0].find('set') ]
